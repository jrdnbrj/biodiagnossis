...
import { loadPublicData, submitHomeRequest } from "./services/public-site";
      ...
      <header className="sticky top-0 z-50 border-b border-slate-200/80 bg-white/95 backdrop-blur">
        <div className="bg-blue-950 text-white">
          <div className="mx-auto flex max-w-7xl flex-wrap items-center justify-center gap-x-6 gap-y-1 px-4 py-2 text-center text-xs sm:justify-between sm:px-6">
            <span>
              Atención en Quito · La disponibilidad del servicio a domicilio se confirma por WhatsApp
            </span>
            <a
        ...
        <section aria-label="Razones de confianza" className="border-b border-slate-200">
          <div className="mx-auto grid max-w-7xl gap-8 px-4 py-10 sm:px-6 md:grid-cols-3">
            <TrustItem
              ...
              description="Continúe su consulta en WhatsApp y reciba orientación personalizada."
            />
            <TrustItem
              icon={ShieldCheck}
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-6 space-y-2 text-sm text-slate-400">
              <a href="/privacidad.html" className="block hover:text-white">
                Privacidad y tratamiento de datos
              </a>
              <a href="/terminos.html" className="block hover:text-white">
                Términos de uso
              </a>
            </div>
          </div>
